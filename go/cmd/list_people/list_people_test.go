...
func TestWritePersonWritesPerson(t *testing.T) {
	...
	p := pb.Person{
		...
		Phones: []*pb.Person_PhoneNumber{
			{Number: "555-4321", Type: pb.Person_PHONETYPE_HOME},
		},
	}
	// [END populate_proto]
	writePerson(buf, &p)
...
func TestListPeopleWritesList(t *testing.T) {
	...
	in := pb.AddressBook{People: []*pb.Person{
		...
		},
		{
			...
			Phones: []*pb.Person_PhoneNumber{
				{Number: "555-555-5555", Type: pb.Person_PHONETYPE_WORK},
			},
		},
		{
			Name:  "Jack Buck",
			...
			Phones: []*pb.Person_PhoneNumber{
				{Number: "555-555-0000", Type: pb.Person_PHONETYPE_HOME},
				{Number: "555-555-0001", Type: pb.Person_PHONETYPE_MOBILE},
				{Number: "555-555-0002", Type: pb.Person_PHONETYPE_WORK},
			},
		},
		{
			Name:  "Janet Doe",
			...
			Phones: []*pb.Person_PhoneNumber{
				{Number: "555-777-0000"},
				{Number: "555-777-0001", Type: pb.Person_PHONETYPE_HOME},
			},
		},
	}}
	listPeople(buf, &in)
